namespace eval ::optrace {
  variable script "C:/Mario/EE354L_vga_demo/vga_demo.runs/impl_1/vga_top.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/Mario/EE354L_vga_demo/vga_demo.cache/wt [current_project]
